...
const LangSupport UnknownLang = {
    "unknown", "NA", "NA", "NA", {NULL}, {NULL}, 0, 0, false};

const LangSupport CLang = {
    "c", "Main.c", "tc.c", "tc.h",
#ifdef JUDGE_DEBUG
    {"gcc", "Main.c", "-o", "Main", "-std=c11", "-O2", NULL},
#else
    {"gcc", "Main.c", "-o", "Main", "-Wall", "-lm", "--static", "-std=c11", "-DONLINE_JUDGE", "-w", NULL},
#endif
    {"./Main", NULL},
    1,
    1,
...
#ifdef JUDGE_DEBUG
    {"g++", "Main.cpp", "-o", "Main", "-std=c++11", "-O2", NULL},
#else
    {"g++", "Main.cpp", "-o", "Main", "-std=c++11", "-Wall", "-lm", "--static", "-DONLINE_JUDGE", "-w", NULL},
#endif
    {"./Main", NULL},
    1,
    1,
